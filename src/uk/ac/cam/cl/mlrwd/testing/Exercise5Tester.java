...
import uk.ac.cam.tal42.mlrwd.exercises.Exercise4.Exercise4;
import uk.ac.cam.tal42.mlrwd.exercises.Exercise5.Exercise5;
...
public class Exercise5Tester {
	...
	public static void main(String[] args) throws IOException {
		...
		Map<Path,Sentiment> oldSimplePredictions = impl1.simpleClassifier(testSet.keySet(), lexiconFile);
		Map<Path,Sentiment> newSimplePredictions = impl1.simpleClassifier(newTestSet.keySet(), lexiconFile);
		
		oldAccuracy = impl1.calculateAccuracy(testSet, oldSimplePredictions);
		newAccuracy = impl1.calculateAccuracy(newTestSet, newSimplePredictions);
		...
		Exercise4 signTestStuff = new Exercise4();
		
		double signTest = signTestStuff.signTest(newTestSet, newSimplePredictions, newPredictions);
		
		System.out.println("p-Value for 2016 test data:");
