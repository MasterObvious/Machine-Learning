...
public class Exercise4Tester {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(split.validationSet.size());
		...
		double NBvsNB = implementation.signTest(split.validationSet, nbPredictions, nbPredictions);
		System.out.println("NB vs Nb:");
		System.out.println(NBvsNB);
		System.out.println();
	}
}