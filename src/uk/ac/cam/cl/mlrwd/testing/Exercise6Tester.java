...
import uk.ac.cam.tal42.mlrwd.exercises.Exercise6.Exercise6;
...
public class Exercise6Tester {
	...
	public static void main(String[] args) throws IOException {
		...
		Exercise6 implementation =  new Exercise6();

		Map<NuancedSentiment, Double> classProbabilities = implementation.calculateClassProbabilities(split.trainingSet);
		
		
		List<Map<Path,NuancedSentiment>> cvSplit = implementation.splitCVRandom(dataSet, 0);
		...
		double CVAccuracy = implementation.cvAccuracy(implementation.crossValidate(cvSplit));
		System.out.println("Multiclass prediction cross-validated accuracy:");
